...
class eFlexPWM : public Timer
{
  public:
	struct Config
	{
		...
		float duty_cycle; //0-1000, represent 0%-100.0% duty cycle
	...
	void SetDutyCycle(float duty_cycle) override; //value base on period count
  ...
  private:
	...
	void InitChannel(Channel channel, System::Pinout::Name pin_name, bool polarity_inverted = false, float duty_cycle = 0, uint16_t dead_time = 0);
