...
namespace Driver {
    ...
    void eFlexPWM::InitChannel(Channel channel, System::Pinout::Name pin_name, bool polarity_inverted, float duty_cycle, uint16_t dead_time) {
        System::Pinout::Config pin_config;
    ...
    void eFlexPWM::SetDutyCycle(float duty_cycle) {
